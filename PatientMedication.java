...
public class PatientMedication{
    ...
    // Map<Long, List<MedicationSchedule>> persontoMedicationSchedulest = new HashMap<Long,
    // List<MedicationSchedule>>();

    private void addMedicationSchedulestoPerson()
    {
        Person person1 = new Person(123, "tester");
        ...
        // persontoMedicationSchedulest.put(person1, medicationSchedules);
